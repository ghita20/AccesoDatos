...
public class Conductor {
	...
	public String toString() {
		...
		return "Conductor: {" 
				...
				+ "Edad: "+edad +" : " 
				+ "DNI: " +dni 
				+ (coche!=null?" : \n\t\t\t\tCoche asignado: " +coche +" )":"") // Solo imprime los datos del coche si tiene coche
				+ " }";
	}
	...
	public Document toJson ( ) {
		...
		coche.put("apellidos", apellidos);
		coche.put("edad", edad);
		coche.put("dni", dni);
		
		// Si tiene coche escribe la referencia en el Json
		if ( this.coche != null )
			coche.put("ref_coche", this.coche.getIdCoche() );
