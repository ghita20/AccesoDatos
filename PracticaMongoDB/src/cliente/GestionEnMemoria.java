...
public class GestionEnMemoria {
	
	// Cliente ExistDB
	private ClienteMongoDB mongoDB;
	...
	// ***CONSTRUCTOR***
	public GestionEnMemoria() throws Exception {
		// Conexion con MongoDB
		mongoDB = new ClienteMongoDB();
	...
	// Imprime el menu y gestiona las opciones
	private void imprimirMenuPrincipal() {
		...
		try {
			...
			case 4: // Importar desde ficheros a mongoDB ( Importa los datos de los ficheros a la base de datos y despues los recoge en la memoria )
				
				// Este proceso reemplaza la base de datos con el contenido de los ficheros "colecciones/coches y colecciones/conductores"
				mongoDB.importarDesdeFicheros(); 
				...
				// Mensaje
				imprimirMensaje("Se han importado los datos de los ficheros a la base de datos y se han aniadido a la memoria.");
				break;
				
			case 5: // Exportar los datos de mongoDB a ficheros ( Exporta lo que hay en la base de datos, no lo que hay en memoria )
				mongoDB.guardarEnFicheros();
				imprimirMensaje("Datos exportados con exito!");
				break;
				
			case 6: // Guardar cambios en mongoDB
				// Primero elimina todos los nodos de la base de datos
				mongoDB.eliminarTodosLosDatos();
				// Inserta los datos que tenemos almacenados en memoria
				mongoDB.guardarMemoriaEnDB(coches,conductores);
